...
-->
<xsl:stylesheet xmlns:iso="http://purl.oclc.org/dsdl/schematron" xmlns:svrl="http://purl.oclc.org/dsdl/svrl" xmlns:schold="http://www.ascc.net/xml/schematron" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:dgs="http://www.degruyter.com/namespace/schematron-annotation" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:axsl="http://www.w3.org/1999/XSL/TransformAlias" version="1.0">
...
<!-- Overrides skeleton.xsl -->
	...
	<!-- "Rich" parameters -->
		...
		<!-- Process rich attributes.  -->
            ...
            <xsl:if test="ancestor::iso:pattern//@dgs:task_bind[1]">
                <axsl:attribute name="task_bind">
                    <axsl:value-of>
                        <xsl:attribute name="select">
                            <xsl:text>'</xsl:text>
                            <xsl:value-of select="ancestor::iso:pattern//@dgs:task_bind[1]"/>
                            <xsl:text>'</xsl:text>
                        </xsl:attribute>
                    </axsl:value-of>
                </axsl:attribute>
            </xsl:if>
            <axsl:if test="ancestor-or-self::*[local-name()='EDITION']">
                <axsl:attribute name="EDITION_ID">
                    <axsl:value-of select="ancestor-or-self::*[local-name()='EDITION']/@EDITION_ID"/>
                </axsl:attribute>
            </axsl:if>
            <axsl:if test="ancestor-or-self::*[local-name()='TITLE']">
                <axsl:attribute name="TITLE_ID">
                    <axsl:value-of select="ancestor-or-self::*[local-name()='TITLE']/@TITLE_ID"/>
                </axsl:attribute>
            </axsl:if>
            <svrl:text>
